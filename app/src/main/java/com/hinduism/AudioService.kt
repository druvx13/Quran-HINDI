...
class AudioService : Service() {
    ...
    companion object {
        const val ACTION_PLAY = "com.hinduism.ACTION_PLAY"
        const val ACTION_PAUSE = "com.hinduism.ACTION_PAUSE"
        const val ACTION_STOP = "com.hinduism.ACTION_STOP"
        const val EXTRA_URL = "extra_url"

        private const val CHANNEL_ID = "hinduism_audio_channel"
